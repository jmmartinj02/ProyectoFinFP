...
INSERT INTO `eventos` (`id`,`nombre`,`descripcion`,`fecha_inicio`,`fecha_fin`,`lugar`,`max_participantes`,`dificultad`) VALUES ('1','Escalada en Peñón de Ifach nocturno','Ruta guiada para principiantes','2026-11-15 09:00:00','2026-11-15 18:00:00','Calpe','20','facil');
...
INSERT INTO `eventos` (`id`,`nombre`,`descripcion`,`fecha_inicio`,`fecha_fin`,`lugar`,`max_participantes`,`dificultad`) VALUES ('8','prueba2','prueba2','2026-06-08 09:34:00','2026-06-09 09:35:00','merida','8','facil');
...
INSERT INTO `usuarios` (`id`,`nombre`,`apellidos`,`email`,`telefono`,`nivel_escalada`,`password`,`rol`,`fecha_registro`) VALUES ('1','Admin','Administrador','admin@escalada.com','924310756','avanzado','asd123','admin','2025-04-23 22:40:40');
